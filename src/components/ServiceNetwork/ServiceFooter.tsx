      ...
      <div className="footer-content container-fluid bg-dark pt-5 px-sm-3 px-md-5">
        <div className="row py-4">
          <div className="col-lg-4 col-md-6 mb-5">
            ...
            <p className="font-weight-medium text-gray-400">
              <Icon
          ...
          <div className="col-lg-3 col-md-6 mb-5">
            <h5 className="mb-4 text-uppercase text-white font-weight-bold">
              Necesitas ayuda
            </h5>
            <p>
              <a href="/dashboard" className="font-weight-medium mb-4 ml-2">
                Servicios
              </a>
            </p>
          </div>
